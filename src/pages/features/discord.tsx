            ...
            >
              ...
              >
                ...
                <Text textAlign="center">
                  Please make sure you have the rights to add bots in your
                  Discord server
                </Text>
              </VStack>
                  ...
                  <Box flex={1} mb={{ base: 4, md: 0 }}>
                    ...
                    <Text>
                      <OrderedList p={2} fontWeight="500" spacing={2}>
                        <ListItem>
                          Install the Meet with Wallet bot to your community
                          (you need admin rights on your Discord server to do
                          it).
                        </ListItem>
                        <ListItem>
