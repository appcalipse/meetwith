import * as util from '@/utils/image-utils'

describe('image-utils util', () => {
  ...
  it('loads correctly', () => {
    expect(() => require('@/utils/image-utils')).not.toThrow()
  })
  ...
  it('has consistent exports', () => {
    ...
    const second = Object.keys(require('@/utils/image-utils'))
