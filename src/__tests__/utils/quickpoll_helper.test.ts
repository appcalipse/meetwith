import * as util from '@/utils/quickpoll_helper'

describe('quickpoll_helper util', () => {
  ...
  it('loads correctly', () => {
    expect(() => require('@/utils/quickpoll_helper')).not.toThrow()
  })
  ...
  it('has consistent exports', () => {
    ...
    const second = Object.keys(require('@/utils/quickpoll_helper'))
