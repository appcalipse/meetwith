import * as util from '@/utils/duration.helper'

describe('duration.helper util', () => {
  ...
  it('loads correctly', () => {
    expect(() => require('@/utils/duration.helper')).not.toThrow()
  })
  ...
  it('has consistent exports', () => {
    ...
    const second = Object.keys(require('@/utils/duration.helper'))
