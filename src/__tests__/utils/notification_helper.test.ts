import * as util from '@/utils/notification_helper'

describe('notification_helper util', () => {
  ...
  it('loads correctly', () => {
    expect(() => require('@/utils/notification_helper')).not.toThrow()
  })
  ...
  it('has consistent exports', () => {
    ...
    const second = Object.keys(require('@/utils/notification_helper'))
