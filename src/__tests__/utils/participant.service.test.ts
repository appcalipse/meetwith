import * as util from '@/utils/participant.service'

describe('participant.service util', () => {
  ...
  it('loads correctly', () => {
    expect(() => require('@/utils/participant.service')).not.toThrow()
  })
  ...
  it('has consistent exports', () => {
    ...
    const second = Object.keys(require('@/utils/participant.service'))
