import * as util from '@/utils/huddle.helper'

describe('huddle.helper util', () => {
  ...
  it('loads correctly', () => {
    expect(() => require('@/utils/huddle.helper')).not.toThrow()
  })
  ...
  it('has consistent exports', () => {
    ...
    const second = Object.keys(require('@/utils/huddle.helper'))
