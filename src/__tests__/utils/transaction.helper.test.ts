import * as util from '@/utils/transaction.helper'

describe('transaction.helper util', () => {
  ...
  it('loads correctly', () => {
    expect(() => require('@/utils/transaction.helper')).not.toThrow()
  })
  ...
  it('has consistent exports', () => {
    ...
    const second = Object.keys(require('@/utils/transaction.helper'))
