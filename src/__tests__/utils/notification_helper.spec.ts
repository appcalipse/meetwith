...
const mockAccountNotifications: AccountNotifications = {
...
describe('notification_helper', () => {
  ...
  describe('notifyForGroupInviteJoinOrReject', () => {
    it('should send email notifications for group invite', async () => {
      ...
      expect(database.getAccountNotificationSubscriptions).toHaveBeenCalledTimes(2)
  ...
  describe('notifyForMeetingCancellation', () => {
    const mockMeetingCancelRequest: MeetingCancelSyncRequest = {
    ...
    it('should handle empty guests and addresses', async () => {
      const emptyRequest: MeetingCancelSyncRequest = {
  ...
  describe('notifyForOrUpdateNewMeeting', () => {
    ...
    it('should handle guest email participants', async () => {
      const requestWithGuest: MeetingCreationSyncRequest = {
        ...mockMeetingRequest,
        participants: [
          {
            guest_email: 'guest@example.com',
    ...
    it('should not send Discord notification to the acting participant', async () => {
      const requestSameParticipant: MeetingCreationSyncRequest = {
        ...mockMeetingRequest,
        participants: [
          {
    ...
    it('should change ADD mapping to CREATE changeType', async () => {
      const requestWithAdd: MeetingCreationSyncRequest = {
        ...mockMeetingRequest,
        participants: [
          {
            account_address: '0x456',
    ...
    it('should handle empty participants array', async () => {
      const requestNoParticipants: MeetingCreationSyncRequest = {
        ...mockMeetingRequest,
        participants: [],
      }
