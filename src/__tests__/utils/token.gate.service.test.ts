import * as util from '@/utils/token.gate.service'

describe('token.gate.service util', () => {
  it('exports module', () => {
  ...
  it('loads without error', () => {
    expect(() => require('@/utils/token.gate.service')).not.toThrow()
  })
  ...
  it('is stable', () => {
    const first = require('@/utils/token.gate.service')
    const second = require('@/utils/token.gate.service')
