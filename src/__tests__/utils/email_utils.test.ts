import * as util from '@/utils/email_utils'

describe('email_utils util', () => {
  ...
  it('loads correctly', () => {
    expect(() => require('@/utils/email_utils')).not.toThrow()
  })
  ...
  it('has consistent exports', () => {
    ...
    const second = Object.keys(require('@/utils/email_utils'))
