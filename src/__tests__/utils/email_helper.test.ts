import * as util from '@/utils/email_helper'

describe('email_helper util', () => {
  ...
  it('loads correctly', () => {
    expect(() => require('@/utils/email_helper')).not.toThrow()
  })
  ...
  it('has consistent exports', () => {
    ...
    const second = Object.keys(require('@/utils/email_helper'))
