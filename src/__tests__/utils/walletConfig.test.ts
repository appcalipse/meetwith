import * as util from '@/utils/walletConfig'

describe('walletConfig util', () => {
  ...
  it('loads correctly', () => {
    expect(() => require('@/utils/walletConfig')).not.toThrow()
  })
  ...
  it('has consistent exports', () => {
    ...
    const second = Object.keys(require('@/utils/walletConfig'))
