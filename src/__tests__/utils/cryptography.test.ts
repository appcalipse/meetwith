import * as util from '@/utils/cryptography'

describe('cryptography util', () => {
  ...
  it('loads correctly', () => {
    expect(() => require('@/utils/cryptography')).not.toThrow()
  })
  ...
  it('has consistent exports', () => {
    ...
    const second = Object.keys(require('@/utils/cryptography'))
