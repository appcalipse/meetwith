import * as util from '@/utils/rpc_helper_front'

describe('rpc_helper_front util', () => {
  ...
  it('loads correctly', () => {
    expect(() => require('@/utils/rpc_helper_front')).not.toThrow()
  })
  ...
  it('has consistent exports', () => {
    ...
    const second = Object.keys(require('@/utils/rpc_helper_front'))
