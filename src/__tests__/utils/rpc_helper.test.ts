import * as util from '@/utils/rpc_helper'

describe('rpc_helper util', () => {
  ...
  it('loads correctly', () => {
    expect(() => require('@/utils/rpc_helper')).not.toThrow()
  })
  ...
  it('has consistent exports', () => {
    ...
    const second = Object.keys(require('@/utils/rpc_helper'))
