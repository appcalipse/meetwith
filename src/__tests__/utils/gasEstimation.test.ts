import * as util from '@/utils/gasEstimation'

describe('gasEstimation util', () => {
  ...
  it('loads correctly', () => {
    expect(() => require('@/utils/gasEstimation')).not.toThrow()
  })
  ...
  it('has consistent exports', () => {
    ...
    const second = Object.keys(require('@/utils/gasEstimation'))
