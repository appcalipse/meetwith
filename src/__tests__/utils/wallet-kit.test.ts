import * as util from '@/utils/wallet-kit'

describe('wallet-kit util', () => {
  ...
  it('loads correctly', () => {
    expect(() => require('@/utils/wallet-kit')).not.toThrow()
  })
  ...
  it('has consistent exports', () => {
    ...
    const second = Object.keys(require('@/utils/wallet-kit'))
