...
export const PrivacyPolicyContent = () => (
  <>
    ...
    <Text color="text-secondary" fontSize="sm" my={2}>
    ...
    <Text color="text-secondary" fontSize="sm" my={3}>
    ...
    <Text as="h4" color="text-secondary" fontWeight={500} fontSize="md" mt={3}>
      Visitors
    </Text>
    <Text color="text-secondary" fontSize="sm" my={2}>
    ...
    <Text color="text-secondary" fontSize="sm" my={2} pb={4}>
