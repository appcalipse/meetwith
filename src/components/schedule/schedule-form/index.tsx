...
export const ScheduleForm: React.FC<ScheduleFormProps> = ({
  ...
  const generateMeetingTitle = () => {
    ...
    const endTime = new Date(
      pickedTime.getTime() + (selectedType.duration_minutes || 30) * 60000
    )
  ...
  const handleConfirm = async () => {
    if (isEmptyString(title) && !showTitleWarning) {
      setShowTitleWarning(true)
      return
    }

    // If warning already shown and user clicks again, proceed with submission
        ...
        {showTitleWarning && title.trim() === '' && (
          ...
          >
            <Icon
              ...
              flexShrink={0}
            />
            <Text fontSize="sm" color="warning-text">
              We advise you provide a title for this meeting to avoid confusion.
            </Text>
          </Box>
        )}
      </FormControl>
