...
const appUrl = process.env.NEXT_PUBLIC_ENV !== 'production' ? (process.env.NEXT_PUBLIC_ENV !== 'development' ? 'http://localhost:3000/' : 'https://meet-with-wallet-git-develop-appcalipse.vercel.app/') : 'https://meetwithwallet.xyz/';
